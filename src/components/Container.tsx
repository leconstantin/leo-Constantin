...
const meta: Record<string, { title: string; description: string }> = {
  ...
  certificates:{
    ...
    description: "A Comprehensive Collection of Industry-Recognized Certifications That Highlight My Dedication to Professional Growth, Mastery of Relevant Technologies, and Commitment to Staying Ahead in an Ever-Evolving Digital Landscape."
  }
};
